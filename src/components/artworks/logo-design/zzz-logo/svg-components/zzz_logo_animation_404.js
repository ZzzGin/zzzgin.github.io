...
const ZzzLogoAnimation404 = () => {
    ...
    useEffect(() => {
        animationRef.current = anime.timeline(
            ...
            scale: 1,
            translateX: (el, i) => anime.random(-404, 404),
            translateY: (el, i) => anime.random(-404, 404),
        }).add({
            scale: 1,
            translateX: (el, i) => anime.random(-404, 404),
            translateY: (el, i) => anime.random(-404, 404),
    ...
    return (
        ...
        <div className="zzginLogoAnimation">
            ...
            <div className="loss-number-404"
                dangerouslySetInnerHTML={{__html: katex.renderToString("\\Delta: "+parseInt(404)+"\\iff \\aleph ^{o}t\\oint^{404}_{ound}", {throwOnError: false, displayMode: true})}}
            >
            </div>
        </div>
...
export default ZzzLogoAnimation404;